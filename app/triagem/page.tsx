...
import { X, Heart, Flame, User } from 'lucide-react';
...
function MatchesContent() {
  ...
  return (
    <>
      ...
      <main className="relative flex min-h-[100dvh] flex-col items-center pt-10 pb-32 px-6 overflow-x-hidden">

        {showToast && (
          <div className="fixed top-8 z-[100] animate-in slide-in-from-top duration-500 bg-orange-500 text-white px-6 py-3 rounded-full shadow-2xl border border-white/20 font-black italic uppercase text-[10px] tracking-widest">
            🔥 Perfil pronto pra festa!
          </div>
        )}
        ...
        {perfilExibido ? (
          /* 💉 CARD DARK GLASS - IGUAL AO PRINT */
          <div className="w-full max-w-sm bg-[#1a1a1a]/80 backdrop-blur-2xl rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.6)] overflow-hidden border border-white/10 flex flex-col animate-in fade-in zoom-in-95 duration-500 relative z-10">
            ...
            <div className="pt-2 pb-10 flex justify-center items-center gap-8">
              {/* DISLIKE (Círculo Escuro com Borda Vermelha) */}
              <button
                onClick={() => votar(false)}
          ...
          <div className="flex-1 w-full max-w-sm flex flex-col items-center justify-center text-center">
            <div className="bg-white/5 backdrop-blur-md p-12 rounded-[3rem] border border-white/5 flex flex-col items-center gap-6 w-full">
              ...
              <h2 className="text-xl font-black text-white uppercase italic">Fim do Radar</h2>
